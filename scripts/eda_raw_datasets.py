...
df_symptom = pd.read_csv('data/raw/symptom2disease_translated_full.csv', encoding='utf-8')
...
stats.append(analyze_lengths(df_symptom, 'text', 'Symptom2Disease', 'symptom_raw'))
...
df_comparison.to_csv('results/tables/datasets_comparison_raw.csv', index=False, encoding='utf-8-sig')
